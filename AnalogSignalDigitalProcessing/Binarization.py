...
cols = ["Two's-completement\n code", "Offset binary code"]
...
tab = plt.table(cellText=data, colLabels=cols, loc='right', cellLoc='center')
...
fig.savefig("Binarization.png", format='png')
plt.show()
